...
First Step download sourse data from link below and unzip it to working directory of R Studio.
Second you must be able to write R script.
About source data
...
File with R code "run_analysis.R" you must do the following steps (in accordance assigned task in the project):
